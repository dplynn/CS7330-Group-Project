...
def main():
    ...
    users_data = DBInit.read_user_data('Lucas_data_files/user_data.csv') # Read user data from CSV file
    ...
    posts_data = DBInit.read_post_data('Lucas_data_files/post_data.csv') # Read post data from CSV file
    ...
    projects_data = DBInit.read_project_data('Lucas_data_files/project_data.csv') # Read project data from CSV file
    ...
    projectdata_data = DBInit.read_projectdata_data('Lucas_data_files/projectdata_data.csv') # Read project data from CSV file
